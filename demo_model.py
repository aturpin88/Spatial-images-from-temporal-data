...
mat_contents = sio.loadmat(folder+'histograms_SPAD.mat') # Can also load 'histograms_RADAR.mat'
histograms = mat_contents['people'] # This is just an example, can load other data

mat_contents = sio.loadmat(folder+'ToF_camera_SPAD.mat') # Can also load 'ToF_camera_RADAR.mat'
